				...
				$.ajax({
					...
					success:function(kindList){
							...
							for(var i=0; i<kindList.length; i++) {
								...
								kindInf+="<td><a href='javascript:showMyModel1("+kind.id+", \""+kind.name+"\");'>修改</a>&nbsp;&nbsp;&nbsp;<a href='javascript:deleteKindById("+kind.id+");'>删除</a></td>";
								kindInf+="</tr>";
							}
				...
				$.ajax({
					...
					success:function(contentList){
							...
							for(var i=0; i<contentList.length; i++) {
								...
								contentInf+="<td>"+content.kind_id+"</td>";
								contentInf+="<td><a href='javascript:showMyModel1con("+content.id+", \""+content.name+"\", \""+content.kind_id+"\");'>修改</a>&nbsp;&nbsp;&nbsp;<a href='javascript:deleteContentById("+content.id+");'>删除</a></td>";
								contentInf+="</tr>";
							}
...
<script type="text/javascript">
			function showMyModel1con(id,name,kind_id) {
				//显示蒙板

				$("#contentId").val(id);
				$("#contentName").val(name);
				$("#contentKind_id").val(kind_id);
			...
			function showAllCource(flag) {
				...
				$.ajax({
					...
					success:function(courceList){
							...
							courceInf+="<th>序号</th>";
							courceInf+="<th>班级</th>";
							courceInf+="<th>班级id</th>";
							courceInf+="<th>老师id</th>";
							courceInf+="<th>日期</th>";
							courceInf+="<th>操作</th>";
							courceInf+="</tr>";
							var cource;
							for(var i=0; i<courceList.length; i++) {
								...
								courceInf+="<td>"+cource.tclass_id+"</td>";
								courceInf+="<td>"+cource.teacher_id+"</td>";
								courceInf+="<td>"+cource.date+"</td>";
								courceInf+="<td><a href='javascript:showMyModel1cource("+cource.id+", \""+cource.name+"\",\""+cource.tclass_id+"\",\""+cource.teacher_id+"\",\""+cource.date+"\");'>修改</a>&nbsp;&nbsp;&nbsp;<a href='javascript:deleteCourceById("+cource.id+");'>删除</a></td>";
								courceInf+="</tr>";
							}
...
<script type="text/javascript">
			function showMyModel1cource(id,name,tclass_id,teacher_id,date) {
				//显示蒙板

				$("#courceId").val(id);
				$("#courceName").val(name);
				$("#courcetclass_id").val(tclass_id);
				$("#courceteacher_id").val(teacher_id);
				$("#courcedate").val(date);
			...
			function updateCource() {
				...
				$.ajax({
					...
					data:{
						"id":$("#courceId").val(),
						"name":$("#courceName").val(),
						"tclass_id":$("#courcetclass_id").val(),
						"teacher_id":$("#courceteacher_id").val(),
						"date":$("#courcedate").val()
					},
					success:function(inf) {
						if(inf==SUCCESS) {
...
<script type="text/javascript">
			function showCource() {
				var id = $("#courceid1").val();
				var name = $("#courcename1").val();
				$.ajax({
					type:"post",
					url: "Cource/showCource.do",
					dataType:"json",
					data:{
						  "id":id,
						  "name":name
...
<body style="background: #fdfbfe;">
	...
	<div class="right" style="margin: auto; width: 80%;" id="bodyer" >
		...
		<div class="rightCont">
			...
			<div id="kind" style="width: 75%;height:auto;">
				<p class="g_title fix">
				...
				<table class="tab1">
					...
					<tr>
						...
						<td><input type="text" class="allInput" value="" id="id1" />
						</td>
						<td width="90" align="right">类别名：</td>
						<td><input type="text" class="allInput" value="" id="name1" />
						</td>
						<td width="85" align="right"><input
								type="button" class="tabSub" value="查 询" onclick="showKind();"/></td>
					</tr>
				...
				<div id="myModel1">
					<div id="model-content" align="center" style="text-align: center; padding-top: 50px">
						...
						<tr><td colspan="2" align="center"><input type="button" name="button" id="button"
									   value="修改" onclick="updateKind()" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="button" id="button"
									   value="取消" onclick="hideModel()" /></td></tr>
						</table>
			...
			<div id="content" style="width: 75%;height:auto;" >
				<p class="g_title fix">
				...
				<table class="tab1">
						...
						<tr>
							<td width="90" align="right">序号：</td>
							<td><input type="text" class="allInput" id="cid1" /></td>
							<td width="90" align="right">项目内容：</td>
							<td><input type="text" class="allInput" id="cname1" /></td>
							<td width="85" align="right"><input type="button"
								class="tabSub" value="查 询" onclick="showContent()"/></td>
						</tr>
				</table>
				...
				<div id="myModelcon" align="center" style="text-align: center;">
					<div id="model-content" style="text-align: center; padding-top: 50px">
						<table border="1" align="center" style="width: 70%;height: 70%">
						<tr><td>项目</td><td><input type="text" value="" id="cname" placeholder="请输入项目"/></td></tr>
						<tr><td>类别id</td><td><input type="text" value="" id="kind_id" placeholder="请输入类别id"></td></tr>
						 <tr>
						<td colspan="2"><input type="button" name="button" id="button"
				...
				<div id="myModel1con">
					...
					<table border="1" align="center" style="width: 70%;height: 70%">
						<tr>
						<td>序号</td><td><input type="text" value="" id="contentId" readonly /></td>
						</tr>
						<tr><td>项目</td><td><input type="text" value="" id="contentName" /></td></tr>
						<tr><td>类别id</td> <td><input type="text" value="" id="contentKind_id"></td></tr>
							<tr> <td colspan="2" align="center"><input type="button" name="button" id="button"
									   value="修改" onclick="updateContent()" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="button" id="button"
			...
			<div id="teacher" style="width: 75%;">
				...
				<table class="tab1">
					<tbody>
						<tr>
							<td width="90" align="right">序号：</td>
							<td><input type="text" class="allInput" value="" id="tid1"/></td>
							<td width="90" align="right">老师：</td>
							<td><input type="text" class="allInput" value="" id="tname1"/></td>
							<td width="85" align="right"><input type="button"
								class="tabSub" value="查 询" onclick="showTeacher()" /></td>
						</tr>
					</tbody>
				</table>
				...
				<div id="myModeltea" align="center" style="text-align: center;">
					...
					<table border="1" align="center" style="width: 70%;height: 70%">
						<tr><td>姓名</td><td><input type="text" value="" id="tname" placeholder="请输入姓名"/></td></tr>
						<tr><td>级别</td><td><input type="text" value="" id="process" placeholder="请输入级别"/></td></tr>
						<tr><td>账号</td><td><input type="text" value="" id="num" placeholder="请输入账号"/></td></tr>
						<tr><td>密码</td><td><input type="text" value="" id="pwd" placeholder="请输入密码"/></td></tr>
						 <tr>
						<td colspan="2"><input type="button" name="button" id="button"
				...
				<div id="myModel1tea" align="center" style="text-align: center;">
					<div id="model-content" style="text-align: center; padding-top: 50px;height:100%">
					<table border="1" align="center" style="width: 70%;height: 70%">
					    <tr><td>序号</td><td><input type="text" value="" id="teacherId" readonly /></td></tr>
						<tr><td>姓名</td><td><input type="text" value="" id="teacherName" /></td></tr>
						<tr><td>级别</td><td><input type="text" value="" id="teacherprocess" /></td></tr>
						<tr><td>账号</td><td><input type="text" value="" id="teachernum" /></td></tr>
						<tr><td>密码</td><td><input type="text" value="" id="teacherpwd" /></td></tr>
							<tr> <td colspan="2" align="center"><input type="button" name="button" id="button"
									   value="修改" onclick="updateTeacher()" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="button" id="button"
									   value="取消" onclick="hideModel()" /></td>
							 </tr>
							</table>
					</div>
			...
			<div id="class" style="width: 75%;">
				...
				<table class="tab1">
					<tbody>
						<tr>
							<td width="90" align="right">序号：</td>
							<td><input type="text" class="allInput" value="" id="classid1"/></td>
							<td width="90" align="right">班级：</td>
							<td><input type="text" class="allInput" value="" id="classname1"/></td>
							<td width="85" align="right"><input type="button"
								class="tabSub" value="查 询" onclick="showTclass()" /></td>
						</tr>
					</tbody>
				</table>
				...
				<div id="myModelclass" align="center" style="text-align: center;">
					<div id="model-content" style="text-align: center; padding-top: 50px;height:100%">
						<table border="1" align="center" style="width: 70%;height: 70%">
						<tr><td>班级</td><td><input type="text" value="" id="classname" placeholder="请输入班级"/></td></tr>
						<tr><td>课程</td><td><input type="text" value="" id="classmajor" placeholder="请输入课程"/></td></tr>
						 <tr>
						<td colspan="2"><input type="button" name="button" id="button"
				...
				<div id="myModel1class" align="center" style="text-align: center;">
					<div id="model-content" style="text-align: center; padding-top: 50px;height:100%">
					<table border="1" align="center" style="width: 70%;height: 70%">
						<tr><td>序号</td><td><input type="text" value="" id="tclassId" readonly /></td></tr>
						<tr><td>班级</td><td><input type="text" value="" id="tclassName" /></td></tr>
						<tr><td>课程</td><td><input type="text" value="" id="tclassmajor" /></td></tr>
							<tr> <td colspan="2" align="center"><input type="button" name="button" id="button"
									   value="修改" onclick="updateTclass()" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="button" id="button"
									   value="取消" onclick="hideModel()" /></td>
							 </tr>
							</table>
					</div>
			...
			<div id="cource" style="width: 75%;">
				...
				<table class="tab1">
						...
						<tr>
							<td width="90" align="right">序号：</td>
							<td><input type="text" class="allInput" value="" id="courceid1"/></td>
							<td width="90" align="right">课程：</td>
							<td><input type="text" class="allInput" value="" id="courcename1"/></td>
							<td width="85" align="right"><input type="button"
								class="tabSub" value="查 询" onclick="showCource();"/></td>
						</tr>
				...
				<div id="myModelcource" align="center" style="text-align: center;">
					<div id="model-content" style="text-align: center; padding-top: 50px;height:100%">
					<table border="1" align="center" style="width: 70%;height: 70%">
						<tr><td>班级</td><td><input type="text" value="" id="courcename" placeholder="请输入班级"/></td></tr>
						<tr><td>班级id</td><td><input type="text" value="" id="tclass_id" placeholder="请输入班级id"/></td></tr>
						<tr><td>老师id</td><td><input type="text" value="" id="teacher_id" placeholder="请输入老师id"/></td></tr>
						<tr><td>日期</td><td><input type="text" value="" id="date" placeholder="请输入日期"/></td></tr>
						 <tr>
						<td colspan="2"><input type="button" name="button" id="button"
				...
				<div id="myModel1cource"  align="center" style="text-align: center;">
					<div id="model-content" style="text-align: center; padding-top: 50px;height:100%">
						<table border="1" align="center" style="width: 70%;height: 70%">
						<tr><td>序号</td><td><input type="text" value="" id="courceId" readonly /></td></tr>
						<tr><td>课程</td><td><input type="text" value="" id="courceName" /></td></tr>
						<tr><td>班级id</td><td><input type="text" value="" id="courcetclass_id" /></td></tr>
						<tr><td>老师id</td><td><input type="text" value="" id="courceteacher_id" /></td></tr>
						<tr><td>日期</td><td><input type="text" value="" id="courcedate" /></td></tr>
						<tr> <td colspan="2" align="center"><input type="button" name="button" id="button"
									   value="修改" onclick="updateCource()" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="button" id="button"
									   value="取消" onclick="hideModel()" /></td>
							 </tr>
						 </table>
					</div>
