...
public interface lx_CourceDao {
    public List<lx_Cource> selectAllCource(int tclass_id);
	public List<lx_Teacher> seleceteacherBycource(String name);
	public List<lx_Cource> selectDateBycourceAndteacher(@Param("name1") String coursename, @Param("name2") String teachername);
